...
import { IconBuilding, IconHistory, IconSliders, IconUpload, IconUsers } from '@/components/Icons';
...
export default async function AdminOverview() {
  ...
  const tiles = [
    ...
    {
      href: '/admin/manage',
      label: 'Ручные изменения',
      hint: 'Закрытия, брони, корректировки занятости',
    ...
    },
    {
      href: '/admin/clubs',
      label: 'Клубы',
      hint: 'Справочник, менеджеры, вместимость',
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-5">
        ...
        <StatCard
          label="Загрузка"
          value={`${s.load_percent}%`}
          accent={s.load_percent > 75 ? 'red' : s.load_percent > 40 ? 'amber' : 'green'}
        />
