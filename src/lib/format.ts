 ...
 */
export type Tone = 'green' | 'amber' | 'red' | 'closed' | 'violet' | 'empty';
...
/**
 * Закрытая раздевалка — это не оттенок серого, а состояние, которое должно
 * быть видно с другого конца комнаты: заливка целиком, белый текст.
 */
export const TONE_CLASS: Record<Tone, string> = {
  ...
  empty: 'bg-ink-100 text-ink-400 ring-ink-200 dark:bg-white/5 dark:text-ink-500 dark:ring-white/10',
};
...
export const TONE_DOT: Record<Tone, string> = {
  ...
  empty: 'bg-ink-300 dark:bg-ink-600',
};
